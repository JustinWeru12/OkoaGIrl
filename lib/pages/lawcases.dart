...
class LawCasesPage extends StatefulWidget {
  @override
  _LawCasesPageState createState() => _LawCasesPageState();
}

class _LawCasesPageState extends State<LawCasesPage> {
        ...
        child: Container(
          ...
          child: StreamBuilder(
              stream: FirebaseFirestore.instance
                  ...
                  .where("persuing", isEqualTo: "Legal Action")
                  .snapshots(),
